...
import { demoFaults, faultTypes } from '@/data/demo-data';
import { Wrench, Search, AlertTriangle, ArrowRight } from 'lucide-react';
...
export default function Faults() {
  ...
  const filtered = demoFaults.filter(f => {
  ...
  return (
    <div className="animate-fade-in">
      <h1 className="page-header">דיווח ומעקב תקלות</h1>
      ...
      <div className="flex gap-2 mb-6 overflow-x-auto">
        ...
        {Object.entries(urgencyLabels).map(([key, { text, cls }]) => (
          <button
            key={key}
